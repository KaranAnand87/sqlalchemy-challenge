...
# Flask Route - Starting on homepage - #1
@app.route("/")
def welcome():
    ...
    return (
        ...
        f"-- Min, Average & Max Temperatures for Start Date: /api/v1.0/trip/yyyy-mm-dd<br>"
...
# Flask Route - Temeprature Observations - #4
...
# Flask Route - Temperature - Min, Max and Average (Start Date)- #5
...
def trip1(start_date, end_date='2017-08-23'):
 ...
 # Flask Route - Temperature - Min, Max and Average (Start Date to End Date)- #6 
